...
<body>
    <div class="sheetbody">
        ...
        <button class="go-to-profile-btn"
            onclick="window.location.href='characterprofile?characterId=<?php echo $character['characterId']; ?>'">Go to
            ...
            <div>
                ...
                <ul>
                    <li><strong>STR:</strong>
                        <?php echo $character['strength'] . ' (' . getAbilityModifier($character['strength']) . ')'; ?>
                    </li>
                    <li><strong>DEX:</strong>
                        <?php echo $character['dexterity'] . ' (' . getAbilityModifier($character['dexterity']) . ')'; ?>
                    </li>
                    <li><strong>CON:</strong>
                        <?php echo $character['constitution'] . ' (' . getAbilityModifier($character['constitution']) . ')'; ?>
                    </li>
                    <li><strong>INT:</strong>
                        <?php echo $character['intelligence'] . ' (' . getAbilityModifier($character['intelligence']) . ')'; ?>
                    </li>
                    <li><strong>WIS:</strong>
                        <?php echo $character['wisdom'] . ' (' . getAbilityModifier($character['wisdom']) . ')'; ?></li>
                    <li><strong>CHA:</strong>
                        <?php echo $character['charisma'] . ' (' . getAbilityModifier($character['charisma']) . ')'; ?>
                    </li>
                </ul>
            </div>
        ...
        <script>
                    ...
                    .then((data) => {
                        if (data.success) {
                            ...
                            fetch("get_currency?characterId=" + characterId)
                                ...
                                .then((currency) => {
                                    const currencyDiv =
                                        document.getElementById("character-currency");
            ...
            function displayItems(items) {
                ...
                items.forEach((item) => {
                    ...
                    div.innerHTML = `${item.name} (${item.type || "Unknown"
